    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavId">
          <ul class="navbar-nav me-auto mt-2 mt-lg-0">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="../RSA/RSA.php">RSA</a>
              </li>
              <li>
              <a class="nav-link active" href="../HASH1/HASH1.php" aria-current="page">Hash1 <span class="visually-hidden"></span></a>
              </li>
              <li>
              <a class="nav-link active" href="HASH2.php" aria-current="page">Hash2 <span class="visually-hidden"></span></a>
              </li>
          </ul>
      </div>
  </div>
...
<div class="container">
  <div class="row">
    ...
    <div class="col-md-4">
      <h1>Metodo Hash 2 (Sha1)</h1>
      <div class="form-group">
        <form action="enviar_hash2.php" method="post">
    ...
    <div class="col-md-4">
      <?php
        if(isset($_POST['decifrar'])){
          ...
          $id = $_POST['id'];
          $clave = $_POST['contra'];
          $sql = "SELECT passencript FROM `hash2` WHERE id = '$id'; ";
          ...
          echo $contra;
          if($claveHash == $contra){
            $sql2 = "SELECT * FROM `hash2` WHERE id = '$id'; ";
