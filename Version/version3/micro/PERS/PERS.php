    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavId">
          <ul class="navbar-nav me-auto mt-2 mt-lg-0">
              ...
              <li class="nav-item">
                  <a class="nav-link" href="../RSA/RSA.php" aria-current="page">RSA<span class="visually-hidden"></span></a>
              </li>
              <li>
              <a class="nav-link active" href="../HASH1/HASH1.php" aria-current="page">Hash1 <span class="visually-hidden"></span></a>
              </li>
              <li>
              <a class="nav-link active" href="../HASH2/HASH2.php" aria-current="page">Hash2 <span class="visually-hidden"></span></a>
              </li>
              <li>
              <a class="nav-link active" href="PERS.php" aria-current="page">PERS <span class="visually-hidden"></span></a>
              </li>
          </ul>
      </div>
  </div>
    ...
    <div class="col-md-4">
      <?php
        if(isset($_POST['decifrar'])){
          ...
          $id = $_POST['id'];
          $clave = $_POST['contra'];
          $sql = "SELECT * FROM `pers` WHERE id = '$id' AND contra = '$clave'; ";
          ...
          <h3>Domicilio:<?php echo descript($row['domicilio'],$clave)?></h3></br>
          <h3>Identificación:<?php echo descript($row['identificacion'],$clave)?></h3></br><?php
          }
        }else{ 
       ?>
      <h3>Nombre:</h3></br>
